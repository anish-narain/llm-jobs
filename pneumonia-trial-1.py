# Inspired by 7-mult-llama3-clean.py, just changed it to write to a csv and also keep track of discharge text length
...
if __name__ == "__main__":
    main(
        ...
        chunk_size=4096,
        chunk_overlap=100,
        output_csv_file='pneumonia-trial-1.csv',  # Change the output file name to a CSV file
        progress_report_file='progress_report.txt',  # Path to the progress report file
        num_patients = 100
    )
